...
t_habitacion= int(input("ingrese tipo de habitación: 1) individual 2) doble 3) suite \n"))
c_noche = int(input("Ingrese cantidad de noches: \n"))
...
if edad > 0 and edad < 18:
    ...
    descuento = 1
valor_pro = habitacion * descuento
